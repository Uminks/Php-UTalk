    <div class="tab-pane fade" id="agregar" role="tabpanel"  aria-labelledby="add-tab">

      <div class="add-container">
        <input type="text" class="form-control" placeholder="Buscar amigo por nombre de usuario">
